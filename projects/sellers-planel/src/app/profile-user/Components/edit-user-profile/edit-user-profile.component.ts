  ...
  ngOnInit() {
    ...
    this.AuthService.GetByID(this.userId).subscribe({
      next: (response) => {
        ...
        this.Frist_Name = this.EditUserForm.controls['FirstName'].setValue(
          this.user.frist_Name
        );
        this.Last_Name = this.EditUserForm.controls['last_Name'].setValue(
          this.user.last_Name
        );
        this.UserName = this.EditUserForm.controls['UserName'].setValue(
          this.user.userName
        );
        this.Email = this.EditUserForm.controls['Email'].setValue(
          this.user.email
        );
        this.Phone1 = this.EditUserForm.controls['Mobile1'].setValue(
          this.user.phone1
        );
        this.Phone2 = this.EditUserForm.controls['Mobile2'].setValue(
          this.user.phone2
        );
        this.Address = this.EditUserForm.controls['Address'].setValue(
          this.user.address
        );
      },
    });
        ...
        if (id) {
          ...
          swal({
            ...
            if (willUpdate) {
              ...
              this.AuthService.UpdateUser(fd).subscribe(
                (data) => {
